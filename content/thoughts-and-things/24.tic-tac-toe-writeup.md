...
So, I mentioned in :content-link{to="/thoughts-and-things/tic-tac-toe"}[the previous post] where I made a tic-tac-toe game, that I made some choices that I thought were interesting and that I might write some things about those choices. So here we go!
