...
<template>
    <div class="drum-machine">
        ...
        <div class="step-pane" :style="{ '--max-steps': maxSteps }">
            ...
            <!-- Tracks -->
            <template v-for="({ name, steps }, trackIndex) of tracks">
                <div class="track-header">
                    <span>{{ name }}</span>
                    <input type="number" min="1" v-model="tracks[trackIndex].steps"
                        class="bg-transparent w-14 ml-auto border border-slate-400 rounded pl-2" />
